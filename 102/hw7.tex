...
\begin{enumerate}
      ...
      \item \begin{enumerate}
                  \item By a similar process to what we did in \ref{list:2b}, we have
                        ...
                        This only preserves odd $k$, as add even $k$ $e^{-jk\pi}=1$ and the term becomes $0$.
                  ...
                  \item \begin{enumerate}
                              \item \[\begin{aligned}
                                                \lt{f(t)}
                                                 ...
                                                 & = \left(\lt{e^{-at}t}-\lt{e^{-at}\cos 2\omega_0t}\right) \div 2         \\
                                                 & = \left(\frac{1}{(s+a)^2}-\frac{s+a}{(s+a)^2+4\omega_0^2}\right) \div 2 \\
                                                 & = \boxed{\frac{1}{2(s+a)^2}-\frac{s+a}{2(s+a)^2+8\omega_0^2}}
                                          \end{aligned}\]
                              \item \[\begin{aligned}
                                                \lt{f(t)}
