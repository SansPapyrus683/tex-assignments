...
\begin{enumerate}
      \item The shortest path is
            ...
            For convenience, let $d(a, b)$ be the distance from $a$ to $b$.
            It's $\infty$ if the two aren't adjacent.

            The equation for \c{Distance} is
            \[\c{Distance}(P, R) = \min_{n \in N} (\c{Distance}(P, n) + d(R, n))\]
            and for \c{MinMaxPacketSize} it's
            \[\c{MinMaxPacketSize}(P, R) = \min_{n \in \c{Closest}(P, R)} \c{MinMaxPacketSize}(P, n)\]
            where
            \[\c{Closest}(P, R) = \{n \in N \mid \c{Distance}(P, n) + d(R, n) = \c{Distance}(P, R)\}\]
      ...
      \item The system takes $3$ time steps to converge.
            ...
            $t=1$:
            \begin{center}
                  \includegraphics[width=11cm]{img/hw3/t1}
            \end{center}

            $t=2$:
            \begin{center}
                  \includegraphics[width=11cm]{img/hw3/t2}
            \end{center}

            $t=3$:
            \begin{center}
                  \includegraphics[width=11cm]{img/hw3/t3}
            \end{center}
