...
% We do the Ratio Test first:
% \begin{align*}
%   \frac{\frac{n}{2^{n+2}}}{\frac{n-1}{2^{n+1}}}
%    & = \frac{\frac{n}{n-1}}{\frac{2^{n+2}}{2^{n+1}}} \\
%    & = \frac{\frac{n}{n-1}}{2}                       \\
%    & = \frac{1-\frac{1}{n}}{2}
% \end{align*}
% This sequence converges to $\frac{1}{2} < 1$ as $n \to \infty$,
% so the series must absolutely converge since it's positive.
