...
% $a_n > 0$, since $a_1 > 1$ and $1-\frac{1}{(n+1)^2}>0\ \forall n \in \N$.
% Both terms in the recurrence are positive, so multiplying them should
% yield another positive number.

% Also, $0 < 1-\frac{1}{(n+1)^2} < 1$ since the fraction is positive,
% meaning $a_{n+1} < a_n$ and that $a_n$ is strictly decreasing.
% These two facts combined imply the convergence of $a_n$. $\square$
