...
\begin{align*}
    ...
    ={} & H_3(p_1p_2, (1-p_1)(1-p_2), p_1+p_2-p_1p_2)
\end{align*}
...
\begin{align*}
    ...
    ={} & H_4(p_1(1-p_2), p_1p_2, (1-p_1)(1-p_2), (1-p_1)p_2)                                                    \\
    ={} & H_3(p_1p_2, (1-p_1)(1-p_2), p_1+p_2-p_1p_2)                                                            \\
        & + (p_1+p_2-p_1p_2)H_2\left(\frac{p_1(1-p_2)}{p_1+p_2-p_1p_2}, \frac{(1-p_1)p_2}{p_1+p_2-p_1p_2}\right)
\end{align*}
and thus
\[H(Y)=H(p_1)+H(p_2) - \alpha H(q)\]
where
\begin{gather*}
    \alpha = p_1+p_2-p_1p_2 \\
    q = \frac{p_1(1-p_2)}{p_1+p_2-p_1p_2}
\end{gather*}
...
As we can see, the red does not completely contain the green.
...
The plot for $p_1=0.5$ is as follows:
\begin{center}
