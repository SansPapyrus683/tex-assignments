...
\begin{align*}
  ...
  \le{} & \frac{R}{2} \int_{0}^{\pi/2-R^{-3/2}} \exp(-R^2\cos(\theta))\,d\theta + \frac{R}{2} \cdot R^{-3/2} \\
  \le{} & \frac{R}{2} \cdot \frac{\pi}{2} \cdot \exp(-R^2\cos(\pi/2-R^{-3/2})) + \frac{1}{2\sqrt{R}} \\
  ={} & \frac{R}{2} \cdot \frac{\pi}{2} \cdot \exp(-R^2\sin(R^{-3/2})) + \frac{1}{2\sqrt{R}}
\end{align*}
...
\[\lim_{R \to \infty} \frac{R}{2}\exp(R^{-1/2}) + \frac{1}{2\sqrt{R}}=0\]
